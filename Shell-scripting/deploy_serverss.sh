...
BASTION_KEY="/home/vagrant/.vagrant/machines/bastion/virtualbox/private_key"  # Correct Linux path to the bastion's private key

# Explicitly set the key environment variable to prevent issues with missing $BASTION_KEY
export BASTION_KEY="/home/vagrant/.vagrant/machines/bastion/virtualbox/private_key"
...
deploy_server() {
    ...
    # Inside the bastion, SSH into the target server using its private key
